...
const docSlider = (function () {
    ...
    const f = {
        ...
        createInner: function () {
            ...
            const wrapper = document.querySelector(op.classSelector);
            const inner = document.createElement('div');
            const pages = document.querySelectorAll(op.classSelector + ' > *:not(.docSlider-pager)');
        ...
        createPager: function () {
            ...
            if (document.querySelector('.docSlider-pager')) {
                ...
                document.querySelector(op.classSelector).appendChild(pager);
        ...
        setData: function () {
            ...
            d.wrapper = document.querySelector(op.classSelector);
